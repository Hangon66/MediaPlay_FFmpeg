...
QT_MOC_LITERAL(1, 10, 24), // "signal_AudioPlayFinished"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "AudioPlay\0signal_AudioPlayFinished\0"
};
...
void AudioPlay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_AudioPlayFinished(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AudioPlay::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AudioPlay::signal_AudioPlayFinished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AudioPlay::staticMetaObject = { {
    ...
    qt_meta_stringdata_AudioPlay.data,
...
// SIGNAL 0
void AudioPlay::signal_AudioPlayFinished()
{
